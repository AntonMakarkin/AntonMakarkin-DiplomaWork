...
const { addOrder, getOrders, getOrdersByCourier, getOrderById, getOrderByIdForStoreKeepeer, 
        getOrderByIdForCourier, updateOrderById, updateOrderByIdByCourier } = orderControllers;
...
router.patch('/orders/:id/couriers/me', auth([Courier]), updateOrderByIdByCourier())
